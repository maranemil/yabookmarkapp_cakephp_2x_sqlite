...
//whether to scan the subdirectories of the above directory infinitely deep
...
//whether to put the app in debug mode where errors are outputted
$debug = false;
